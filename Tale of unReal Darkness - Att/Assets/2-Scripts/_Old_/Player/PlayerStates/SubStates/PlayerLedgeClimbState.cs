...
public class PlayerLedgeClimbState : PlayerState {
	...
	//teste
	public bool ceiling; //verificar se está tocando teto para usar em outro lugar (corrigir bugs)
	...
	public override void LogicUpdate() {
		...
		if (isAnimationFinished) {
            ...
            /*else if (jumpInput && !isClimbing) { //essa funçao faz com que o player dê wall jump ao apertar espaço
				player.WallJumpState.DetermineWallJumpDirection(true);
				stateMachine.ChangeState(player.WallJumpState);
			}*/

            else if (jumpInput && !isClimbing) { //essa funçao faz com que o player suba a quina ao apertar espaço
				CheckForSpace();
                isClimbing = true;
                player.Anim.SetBool("climbLedge", true);
            }
