...
public class PlayerInAirState : PlayerState
{
    ...
    private bool coyoteLedgeClimbTime;
    ...
    public override void LogicUpdate()
    {
        ...
        else if (isTouchingWall && !isTouchingLedge && !isGrounded && coyoteLedgeClimbTime==true)
        {
    ...
    private void CheckCoyoteLedgeClimbTime()
    {
        if (coyoteLedgeClimbTime == false && Time.time > playerData.coyoteLedgeClimbTime)
        {
            coyoteLedgeClimbTime = true;
        }
    }
    ...
    public void StartLedgeClimbCoyoteTime() => coyoteLedgeClimbTime = false;
