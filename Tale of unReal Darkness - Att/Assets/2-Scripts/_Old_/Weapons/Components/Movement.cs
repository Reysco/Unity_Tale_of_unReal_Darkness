...
namespace Bardent.Weapons.Components
{
    public class Movement : WeaponComponent<MovementData, AttackMovement>
    {
        ...
        {
            coreMovement.SetVelocity(velocity, direction, coreMovement.FacingDirection); //aqui define se o player vai parar para atacar ou nao
        }

        private void SetVelocityX()
        {
            coreMovement.SetVelocityX((direction * velocity).x * coreMovement.FacingDirection); //aqui define se o player vai parar para atacar ou nao
        }
